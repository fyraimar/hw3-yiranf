...
package edu.cmu.lti.f14.hw3.hw3_yiranf.typesystems;
...
/** 
 * Updated by JCasGen Thu Oct 16 11:23:53 EDT 2014
 * XML source: /Users/yiranfei/git/hw3-yiranf/hw3-yiranf/src/main/resources/descriptors/typesystems/VectorSpaceTypes.xml
 * @generated */
  ...
  *
  ...
  public int getRelevanceValue() {
    if (Document_Type.featOkTst && ((Document_Type)jcasType).casFeat_relevanceValue == null)
      jcasType.jcas.throwFeatMissing("relevanceValue", "edu.cmu.lti.f14.hw3.hw3_yiranf.typesystems.Document");
  ...
  public int getQueryID() {
    if (Document_Type.featOkTst && ((Document_Type)jcasType).casFeat_queryID == null)
      jcasType.jcas.throwFeatMissing("queryID", "edu.cmu.lti.f14.hw3.hw3_yiranf.typesystems.Document");
  ...
  public String getText() {
    if (Document_Type.featOkTst && ((Document_Type)jcasType).casFeat_text == null)
      jcasType.jcas.throwFeatMissing("text", "edu.cmu.lti.f14.hw3.hw3_yiranf.typesystems.Document");
  ...
  public FSList getTokenList() {
    if (Document_Type.featOkTst && ((Document_Type)jcasType).casFeat_tokenList == null)
      jcasType.jcas.throwFeatMissing("tokenList", "edu.cmu.lti.f14.hw3.hw3_yiranf.typesystems.Document");
